...
import SizeFilter from "../allproduct/size";
import ColorFilter from "../allproduct/color";
import MobileFilter from "../allproduct/mobfilter";
import MobileSort from "../allproduct/mobsort";




function CutomCategory(props){
 ...
 useEffect(()=>{
    ...
    axios.post(`${server}/findproductwithspecificategory`,{category:props.category}).then(res=>{
...
const MakeProductFilterSize =(item)=>{
  ...
  axios.post(`${server}/filterproductnocategory`,{size:item,color:colorfilteredproduct}).then(res=>{
...
const MakeProductFilterColor =(item)=>{
  ...
  axios.post(`${server}/filterproductnocategory`,{size:sizefilteredproduct,color:item}).then(res=>{
